...
##Buttons
set_property PACKAGE_PIN U18 [get_ports reset_bt]						
  set_property IOSTANDARD LVCMOS33 [get_ports reset_bt]
...
##USB-RS232 Interface
set_property PACKAGE_PIN B18 [get_ports rx_input]						
	set_property IOSTANDARD LVCMOS33 [get_ports rx_input]
set_property PACKAGE_PIN A18 [get_ports tx_output]						
	set_property IOSTANDARD LVCMOS33 [get_ports tx_output]
